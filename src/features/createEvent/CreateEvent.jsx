  ...
  return (
    <>
      <section className="px-5 font-openSans max-w-7xl m-auto py-5">
        <div className="inline-flex items-center gap-2 text-xl lg-screen:text-2xl text-[##2D2C3C] font-extrabold">
          <IoIosArrowRoundBack
            color="#2B293D"
            className="text-3xl lg-screen:text-4xl"
            onClick={oneClickBack}
          />
          <h2>Create a New Event</h2>
        </div>
        <div className="px-0 sm-screen:px-9 lg-screen:px-0">
